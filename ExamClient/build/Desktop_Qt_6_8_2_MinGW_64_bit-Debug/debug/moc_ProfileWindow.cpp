...
static constexpr auto qt_meta_stringdata_ZN13ProfileWindowE = QtMocHelpers::stringData(
    "ProfileWindow",
    "backRequested",
    "",
...
Q_CONSTINIT static const uint qt_meta_data_ZN13ProfileWindowE[] = {
...
Q_CONSTINIT const QMetaObject ProfileWindow::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN13ProfileWindowE.offsetsAndSizes,
    qt_meta_data_ZN13ProfileWindowE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN13ProfileWindowE_t,
        // Q_OBJECT / Q_GADGET
...
void ProfileWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (ProfileWindow::*)();
            if (_q_method_type _q_method = &ProfileWindow::backRequested; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _q_method_type = void (ProfileWindow::*)();
            if (_q_method_type _q_method = &ProfileWindow::changePasswordRequested; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
void *ProfileWindow::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN13ProfileWindowE.stringdata0))
...
// SIGNAL 1
void ProfileWindow::changePasswordRequested()
{
